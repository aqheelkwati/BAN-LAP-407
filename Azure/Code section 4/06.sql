...
WITH (    LOCATION   = 'abfss://csv@datalake2000233.dfs.core.windows.net',  -- here link format is changed for hadoop external table
          CREDENTIAL = AzureStorageCredential,							-- LOCATION='https://datalake2000233.blob.core.windows.net/csv' this link is changed
          TYPE = HADOOP													--           abfss   csv@            .dfs                 remove /csv
)
